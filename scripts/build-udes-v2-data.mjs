...
const sources = {
  ...
  adsdiRoadCenterline: {
    ...
    publisher: "Department of Government Enablement, Abu Dhabi Spatial Data Infrastructure",
    classification: "observed-reference",
  ...
  scadPopulation: {
    ...
    classification: "observed",
    use: "Abu Dhabi Region total and officially disclosed top-ten district populations",
    referenceYear: 2024,
    retrieved: snapshotDate,
  },
  unHabitatMobility: {
  ...
  osm: {
    ...
    license: "ODbL",
    classification: "observed-base / derived-route",
...
const zoneSpecs = [
  ...
  },
  {
    ...
    mappingNote: "Official Al Manhal polygon used for the combined familiar-area label.",
  },
  {
    id: "al-mushrif",
    name: "Al Mushrif",
  ...
  },
  {
    ...
    mappingNote:
      "Muroor is a familiar corridor-area rather than an AD-SDI district; official Al Sa'adah is used as the reproducible fallback polygon.",
  },
  {
    id: "al-rawdah",
    name: "Al Rawdah",
  ...
  },
  {
    ...
    mappingNote: "Official Rabdan polygon used for the Rabdan / Al Maqta gateway zone.",
  },
  {
    id: "al-raha",
    name: "Al Raha",
  ...
  },
  {
    ...
    mappingNote: "Two official district polygons combined; only the Mohamed Bin Zayed City population is disclosed in SCAD's 2024 top-ten chart.",
  },
  {
    id: "musaffah",
    name: "Musaffah",
...
async function main() {
  ...
  const baseline = {
    ...
    calibration: {
      ...
      officialTargetDistrictPopulationSubtotal: 1092770,
      ...
      note: "Only six selected districts appear in SCAD's published 2024 top-ten values. Other district populations and all district jobs/behavioral attributes are explicitly synthetic baselines.",
    },
    zones,
    roadGraph: {
    ...
    transit: {
      ...
      links: transitLinks,
      caveat:
        "Stops are observed. Links, frequency, capacity and travel time are modeled because an official route/timetable layer was not available in the AD-SDI open service.",
    },
    assumptions: [
      "Population values for Al Danah, Al Zahiyah, Al Nahyan, Khalifa City, Musaffah and the Mohamed Bin Zayed City component are observed SCAD 2024 top-ten figures.",
      "Other selected-zone population values distribute a plausible metropolitan subtotal but are not official district estimates.",
